...
<p>
  ...
  Log in to DC-1, go to 🔹️ **Server Manager**, click "**Add Roles and Features**" on the Dashboard, on "**Server Selection**" check DC-1, and install **Active Directory Domain Services (ADDS)**. 
